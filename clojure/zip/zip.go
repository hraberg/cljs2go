			...
			if cljs_core.X_EQ_.Arity2IIB((&cljs_core.CljsCoreKeyword{Ns: nil, Name: "end", Fqn: "end", X_hash: float64(-268185958)}), func() interface{} {
			...
			} else {
				{
					var or__177__auto__ = func() interface{} {
						var and__165__auto__ = Branch_QMARK_.X_invoke_Arity1(loc)
						_ = and__165__auto__
						if cljs_core.Truth_(and__165__auto__) {
					...
					if cljs_core.Truth_(or__177__auto__) {
						...
						{
							var or__177__auto_____1 = Right.X_invoke_Arity1(loc)
							...
							} else {
								{
									...
									for {
										if cljs_core.Truth_(Up.X_invoke_Arity1(p)) {
											{
												var or__177__auto_____2 = Right.X_invoke_Arity1(Up.X_invoke_Arity1(p))
												_ = or__177__auto_____2
												if cljs_core.Truth_(or__177__auto_____2) {
							...
							for {
								{
									var temp__4220__auto_____1 = func() interface{} {
										var and__165__auto__ = Branch_QMARK_.X_invoke_Arity1(loc___1)
										_ = and__165__auto__
										if cljs_core.Truth_(and__165__auto__) {
