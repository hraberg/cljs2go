...
func init() {
		...
		return cljs_core.Fn(intersection, func(s1 interface{}) interface{} {
			...
			for {
				if cljs_core.Count.X_invoke_Arity1(s2).(float64) < cljs_core.Count.X_invoke_Arity1(s1).(float64) {
					...
					return cljs_core.Reduce.X_invoke_Arity3(func(G__6 *cljs_core.AFn, s1 interface{}, s2 interface{}) *cljs_core.AFn {
			...
			_, _, _ = s1, s2, sets
			{
				var bubbled_sets = Bubble_max_key.X_invoke_Arity2(func(G__7 *cljs_core.AFn) *cljs_core.AFn {
					return cljs_core.Fn(G__7, func(p1__3_SHARP_ interface{}) interface{} {
		...
		return cljs_core.Fn(difference, func(s1 interface{}) interface{} {
			...
			if cljs_core.Count.X_invoke_Arity1(s1).(float64) < cljs_core.Count.X_invoke_Arity1(s2).(float64) {
				return cljs_core.Reduce.X_invoke_Arity3(func(G__8 *cljs_core.AFn) *cljs_core.AFn {
					return cljs_core.Fn(G__8, func(result interface{}, item interface{}) interface{} {
						if cljs_core.Contains_QMARK_.Arity2IIB(s2, item) {
							return cljs_core.Disj.X_invoke_Arity2(result, item)
						} else {
							return result
	...
	Select_ = func(select_ *cljs_core.AFn) *cljs_core.AFn {
		return cljs_core.Fn(select_, func(pred interface{}, xset interface{}) interface{} {
			return cljs_core.Reduce.X_invoke_Arity3(func(G__9 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__9, func(s interface{}, k interface{}) interface{} {
	...
	Project = func(project *cljs_core.AFn) *cljs_core.AFn {
		return cljs_core.Fn(project, func(xrel interface{}, ks interface{}) interface{} {
			return cljs_core.Set.X_invoke_Arity1(cljs_core.Map_.X_invoke_Arity2(func(G__11 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__11, func(p1__10_SHARP_ interface{}) interface{} {
	...
	Rename_keys = func(rename_keys *cljs_core.AFn) *cljs_core.AFn {
		return cljs_core.Fn(rename_keys, func(map_ interface{}, kmap interface{}) interface{} {
			return cljs_core.Reduce.X_invoke_Arity3(func(G__16 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__16, func(m interface{}, p__14 interface{}) interface{} {
					{
						var vec__15 = p__14
	...
	Rename = func(rename *cljs_core.AFn) *cljs_core.AFn {
		return cljs_core.Fn(rename, func(xrel interface{}, kmap interface{}) interface{} {
			return cljs_core.Set.X_invoke_Arity1(cljs_core.Map_.X_invoke_Arity2(func(G__18 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__18, func(p1__17_SHARP_ interface{}) interface{} {
	...
	Index = func(index *cljs_core.AFn) *cljs_core.AFn {
		return cljs_core.Fn(index, func(xrel interface{}, ks interface{}) interface{} {
			return cljs_core.Reduce.X_invoke_Arity3(func(G__19 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__19, func(m interface{}, x interface{}) interface{} {
					{
	...
	Map_invert = func(map_invert *cljs_core.AFn) *cljs_core.AFn {
		return cljs_core.Fn(map_invert, func(m interface{}) interface{} {
			return cljs_core.Reduce.X_invoke_Arity3(func(G__24 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__24, func(m___1 interface{}, p__22 interface{}) interface{} {
					{
						var vec__23 = p__22
		...
		return cljs_core.Fn(join, func(xrel interface{}, yrel interface{}) interface{} {
			if cljs_core.Truth_(func() interface{} {
			...
			}()) {
				{
					...
					var vec__31 = func() cljs_core.CljsCoreIVector {
					...
					var r = cljs_core.Nth.X_invoke_Arity3(vec__31, float64(0), nil)
					var s = cljs_core.Nth.X_invoke_Arity3(vec__31, float64(1), nil)
					var idx = Index.X_invoke_Arity2(r, ks)
					_, _, _, _, _ = ks, vec__31, r, s, idx
					return cljs_core.Reduce.X_invoke_Arity3(func(G__33 *cljs_core.AFn, ks interface{}, vec__31 cljs_core.CljsCoreIVector, r interface{}, s interface{}, idx interface{}) *cljs_core.AFn {
						return cljs_core.Fn(G__33, func(ret interface{}, x interface{}) interface{} {
							{
								...
								if cljs_core.Truth_(found) {
									return cljs_core.Reduce.X_invoke_Arity3(func(G__34 *cljs_core.AFn, found interface{}, ks interface{}, vec__31 cljs_core.CljsCoreIVector, r interface{}, s interface{}, idx interface{}) *cljs_core.AFn {
									...
									}(&cljs_core.AFn{}, found, ks, vec__31, r, s, idx), ret, found)
								} else {
									return ret
								}
							}
						})
					}(&cljs_core.AFn{}, ks, vec__31, r, s, idx), cljs_core.CljsCorePersistentHashSet_EMPTY, s)
				}
			} else {
				return cljs_core.CljsCorePersistentHashSet_EMPTY
			}
			...
			{
				var vec__32 = func() cljs_core.CljsCoreIVector {
					if cljs_core.Count.X_invoke_Arity1(xrel).(float64) <= cljs_core.Count.X_invoke_Arity1(yrel).(float64) {
				...
				var r = cljs_core.Nth.X_invoke_Arity3(vec__32, float64(0), nil)
				var s = cljs_core.Nth.X_invoke_Arity3(vec__32, float64(1), nil)
				var k = cljs_core.Nth.X_invoke_Arity3(vec__32, float64(2), nil)
				var idx = Index.X_invoke_Arity2(r, cljs_core.Vals.X_invoke_Arity1(k))
				_, _, _, _, _ = vec__32, r, s, k, idx
				return cljs_core.Reduce.X_invoke_Arity3(func(G__35 *cljs_core.AFn, vec__32 cljs_core.CljsCoreIVector, r interface{}, s interface{}, k interface{}, idx interface{}) *cljs_core.AFn {
					return cljs_core.Fn(G__35, func(ret interface{}, x interface{}) interface{} {
						{
							...
							_ = found
							if cljs_core.Truth_(found) {
								return cljs_core.Reduce.X_invoke_Arity3(func(G__36 *cljs_core.AFn, found interface{}, vec__32 cljs_core.CljsCoreIVector, r interface{}, s interface{}, k interface{}, idx interface{}) *cljs_core.AFn {
									return cljs_core.Fn(G__36, func(p1__27_SHARP_ interface{}, p2__28_SHARP_ interface{}) interface{} {
										return cljs_core.Conj.X_invoke_Arity2(p1__27_SHARP_, cljs_core.Merge.X_invoke_ArityVariadic(p2__28_SHARP_, x))
									})
								}(&cljs_core.AFn{}, found, vec__32, r, s, k, idx), ret, found)
							} else {
								return ret
							}
						}
					})
				}(&cljs_core.AFn{}, vec__32, r, s, k, idx), cljs_core.CljsCorePersistentHashSet_EMPTY, s)
			}
		})
	}(&cljs_core.AFn{})
		...
		return cljs_core.Fn(subset_QMARK_, func(set1 interface{}, set2 interface{}) interface{} {
			return (cljs_core.Count.X_invoke_Arity1(set1).(float64) <= cljs_core.Count.X_invoke_Arity1(set2).(float64)) && (cljs_core.Every_QMARK_.Arity2IIB(func(G__38 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__38, func(p1__37_SHARP_ interface{}) interface{} {
					return cljs_core.Contains_QMARK_.Arity2IIB(set2, p1__37_SHARP_)
				})
			}(&cljs_core.AFn{}), set1))
		})
	}(&cljs_core.AFn{})
	...
	Superset_QMARK_ = func(superset_QMARK_ *cljs_core.AFn) *cljs_core.AFn {
		return cljs_core.Fn(superset_QMARK_, func(set1 interface{}, set2 interface{}) interface{} {
			return (cljs_core.Count.X_invoke_Arity1(set1).(float64) >= cljs_core.Count.X_invoke_Arity1(set2).(float64)) && (cljs_core.Every_QMARK_.Arity2IIB(func(G__40 *cljs_core.AFn) *cljs_core.AFn {
				return cljs_core.Fn(G__40, func(p1__39_SHARP_ interface{}) interface{} {
					return cljs_core.Contains_QMARK_.Arity2IIB(set1, p1__39_SHARP_)
				})
			}(&cljs_core.AFn{}), set2))
		})
	}(&cljs_core.AFn{})
